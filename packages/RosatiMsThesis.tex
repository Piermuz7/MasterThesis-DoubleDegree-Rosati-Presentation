...
\node[anchor=west,yshift=-20pt] at (current page.north west) {\includegraphics[height=1.1cm]{../img/logo-unicam-notext.png}};
\node[anchor=north east,yshift=-5pt] at (current page.north east) {\includegraphics[height=0.9cm]{../img/logo-fhnw-notext.png}};
\end{tikzpicture}
\vspace{-0.5cm}
}
...
\input{../sections/introduction/research-collaboration.tex}
%
%\section{Literature Review}
%\input{../sections/literature-review/literature-review.tex}
\section{Related Work}
\input{../sections/literature-review/related-work.tex}
%
\section{Problem Statement}
\input{../sections/problem-statement/problem-statement.tex}
%
\section{Research Questions}
\input{../sections/research-questions/research-questions.tex}
%
\section{Research Design}
\input{../sections/research-design/dsr.tex}
%
\section{Dataset}
\input{../sections/scenario-analysis/dataset.tex}
%
\section{Artifact Design}
\input{../sections/architecture/architecture.tex}
%
\section{Technology stack}
\input{../sections/implementation/artifact-implementation.tex}
%
\section{Evaluation}
\input{../sections/evaluation/evaluation.tex}
%
\section{Conclusion}
\input{../sections/conclusion/conclusions.tex}
\section*{References}
{
